...
render(
    <BrowserRouter>
        <Routes>
            ...
            <Route path="/news/bloomberg/" element={<NewsScreen mode="1"/>}/>
            <Route path="/news/reuters/" element={<NewsScreen mode="2"/>}/>
            <Route path="/news/washingtonpost/" element={<NewsScreen mode="3"/>}/>
            ...
            <Route path="/news/cnn/" element={<NewsScreen mode="7"/>}/>
            <Route path="/news/huffpost/" element={<NewsScreen mode="8"/>}/>
